...
@overload
def read_jstat(path_or_buf: JSONSource, output_type: Literal["pandas"] = "pandas") -> pd.DataFrame: ...
@overload
def read_jstat(path_or_buf: JSONSource, output_type: BackendName = ...) -> Frame: ...
def read_jstat(path_or_buf: JSONSource, output_type: OutputType = "pandas") -> Frame:
